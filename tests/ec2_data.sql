--postgres 14
CREATE TABLE public.ec2_instance_pricing (
...
ALTER TABLE public.ec2_instance_pricing OWNER TO scrpr_test;
ALTER TABLE ONLY public.ec2_instance_pricing
    ADD CONSTRAINT ec2_instance_pricing_pkey PRIMARY KEY (pk);

-- GRANT ALL ON ec2_instance_pricing TO scrpr_test;
-- GRANT ALL

INSERT INTO ec2_instance_pricing (pk, date, instance_type, operating_system, region, cost_per_hr, cpu_ct, ram_size_gb, storage_type, network_throughput)
VALUES (
